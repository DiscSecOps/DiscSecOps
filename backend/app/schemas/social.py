...
class PostResponse(PostBase):
    ...
    id: int
    author_id: int
    author_name: str | None = Field(None, description="Username of author")
    circle_id: int | None
    circle_name: str | None = Field(None, description="Name of the circle if post is in a circle")
    created_at: datetime
...
class UserSearchResponse(BaseModel):
    ...
    username: str
    email: str
    is_already_member: bool = Field(False, description="Whether user is already in the circle")
